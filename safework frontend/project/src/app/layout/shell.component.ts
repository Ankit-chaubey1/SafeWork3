...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Trainings', icon: '🎓', route: '/trainings', roles: ['Manager', 'Administrator','Compliance Officer'] },
  ...
  { label: 'Audit Log', icon: '📝', route: '/audit-log', roles: ['Government Auditor'] },
  { label: 'Notifications', icon: '🔔', route: '/notifications', roles: ['Employee', 'Hazard Officer', 'Manager', 'Administrator', 'Government Auditor'] },
];
