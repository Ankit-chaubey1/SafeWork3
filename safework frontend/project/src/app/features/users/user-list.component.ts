        ...
        <div class="card-header">
          <div class="search-bar" style="margin:0;flex:1">
            <div class="search-input-wrap">
              ...
              <input class="form-control" [ngModel]="search()" (ngModelChange)="search.set($event)" placeholder="Search by name or email..." />
            </div>
            <select class="form-control" style="width:200px" [ngModel]="filterRole()" (ngModelChange)="filterRole.set($event)">
              <option value="">All Roles</option>
              <option *ngFor="let r of roles">{{ r }}</option>
            </select>
            <select class="form-control" style="width:140px" [ngModel]="filterStatus()" (ngModelChange)="filterStatus.set($event)">
