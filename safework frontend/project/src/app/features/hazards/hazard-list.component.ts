  ...
  template: `
    <div class="page">
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:20px">
        <div *ngFor="let s of summaryStats()" class="summary-chip" (click)="filterStatus.set(s.status)">
      ...
      <div class="card">
        <div class="card-header">
          <div class="search-bar" style="margin:0;flex:1">
            <div class="search-input-wrap">
              ...
              <input class="form-control" [ngModel]="search()" (ngModelChange)="search.set($event)" placeholder="Search hazards..." />
            </div>
        ...
        <div class="table-wrapper">
          <table>
            <thead>
              <tr><th>ID</th><th>Description</th><th>Location</th><th>Employee ID</th><th>Date</th><th>Status</th><th>Actions</th></tr>
            </thead>
            <tbody>
              <tr *ngFor="let h of filtered()">
                <td class="text-sm">{{ h.hazardId }}</td>
