        ...
        <div class="card-header">
          <div class="search-bar" style="margin:0;flex:1">
            <div class="search-input-wrap">
              ...
              <input class="form-control" [ngModel]="search()" (ngModelChange)="search.set($event)" placeholder="Search checks..." />
            </div>
            <select class="form-control" style="width:140px" [ngModel]="filterResult()" (ngModelChange)="filterResult.set($event)">
