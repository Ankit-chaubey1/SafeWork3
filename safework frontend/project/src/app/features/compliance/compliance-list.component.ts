    ...
    <div class="page">
      ...
      <div class="card">
        <div class="card-header">
          <div class="search-bar" style="margin:0;flex:1">
            <div class="search-input-wrap">
              ...
              <input class="form-control" [ngModel]="search()" (ngModelChange)="search.set($event)" placeholder="Search compliance records..." />
            </div>
            <select class="form-control" style="width:150px" [ngModel]="filterResult()" (ngModelChange)="filterResult.set($event)">
            ...
            <select class="form-control" style="width:140px" [ngModel]="filterType()" (ngModelChange)="filterType.set($event)">
        ...
        <div class="table-wrapper">
          <table>
            <thead>
              <tr><th>Entity ID</th><th>Entity Type</th><th>Result</th><th>Notes</th><th>Date</th><th>Actions</th></tr>
            </thead>
            <tbody>
              <tr *ngFor="let c of filtered()">
                <td>#{{ c.entityId }}</td>
                <td class="fw-500"><span class="badge badge-primary">{{ c.entityType }}</span></td>
        ...
        <div class="modal-body">
          <div class="form-row">
            <div class="form-group">
              ...
              <input type="number" class="form-control" [(ngModel)]="form.entityId" placeholder="Enter Entity ID" />
            </div>
            <div class="form-group">
